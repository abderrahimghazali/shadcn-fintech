...
import { LandmarkIcon, MailIcon, LockIcon, EyeOffIcon, LoaderIcon, CheckCircle2Icon } from "lucide-react"
        ...
        >
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>Sign in to your Shadcn Fintech account</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {state === "success" ? (
                  ...
                  >
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                      ...
                      <a href="/sign-up" className="font-medium text-primary hover:underline">Sign up</a>
                    </p>
